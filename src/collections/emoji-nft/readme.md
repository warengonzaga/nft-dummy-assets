...
Emoji NFT is a dummy NFT asset composed of 1,000 pieces unique emoji with custom background and patterns generated by [Waren Gonzaga](https://warengonzaga.com) using the [thirdweb art engine](https://github.com/warengonzaga/thirdweb-art-engine). Recommended for testing unique NFT deployment that usess **ERC-721** standard.
